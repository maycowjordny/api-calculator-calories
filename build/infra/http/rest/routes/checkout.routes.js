...
var checkout_routes_exports = {};
__export(checkout_routes_exports, {
  createCheckoutRoutes: () => createCheckoutRoutes
});
module.exports = __toCommonJS(checkout_routes_exports);
...
async function createCheckoutRoutes(app) {
